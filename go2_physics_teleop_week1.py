...
def run_go2_physics_episode(episode, args, repo_root):
    ...
    try:
        ...
        keyboard = None if args.headless else WASDVelocityKeyboard(args)
        ...
        if args.headless and scripted_command is None and gt_follower is None:
        ...
        while simulation_app.is_running():
            ...
            if done_flag:
                ...
                if scripted_command is not None:
                    print("[ABORT] Scripted Go2 physics command stopped because the environment terminated.")
                    break
            ...
            if args.headless and scripted_command is None and frame >= args.go2_physics_max_headless_steps:
